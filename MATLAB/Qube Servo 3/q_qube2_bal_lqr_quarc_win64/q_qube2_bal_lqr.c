...
void q_qube2_bal_lqr_output(void)
{
   ...
   */
  temp_tmp = 6.2831853071795862 * q_qube2_bal_lqr_M->Timing.t[0];

  /* SignalGenerator: '<Root>/Signal Generator' */
  q_qube2_bal_lqr_B.SignalGenerator = sin
    (q_qube2_bal_lqr_P.SignalGenerator_Frequency * temp_tmp) *
  ...
  /* SignalGenerator: '<Root>/Signal Generator1' */
  q_qube2_bal_lqr_B.SignalGenerator1 = sin
    (q_qube2_bal_lqr_P.SignalGenerator1_Frequency * temp_tmp) *
    q_qube2_bal_lqr_P.SignalGenerator1_Amplitude;
  ...
  if (q_qube2_bal_lqr_B.Compare == 0) {
    ...
    q_qube2_bal_lqr_B.EnableBalanceControlSwitch =
      q_qube2_bal_lqr_B.SignalGenerator1;
  } else {
    ...
    /* Gain: '<Root>/u = -K*x' */
    temp_tmp = q_qube2_bal_lqr_P.K[0] * q_qube2_bal_lqr_B.Sum[0];
    temp_tmp += q_qube2_bal_lqr_P.K[1] * q_qube2_bal_lqr_B.Sum[1];
    temp_tmp += q_qube2_bal_lqr_P.K[2] * q_qube2_bal_lqr_B.Sum[2];
    temp_tmp += q_qube2_bal_lqr_P.K[3] * q_qube2_bal_lqr_B.Sum[3];

    /* Gain: '<Root>/u = -K*x' */
    q_qube2_bal_lqr_B.uKx = temp_tmp;
...
void q_qube2_bal_lqr_initialize(void)
{
  ...
  /* S-Function Block: q_qube2_bal_lqr/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    result = hil_set_card_specific_options(q_qube2_bal_lqr_DW.HILInitialize_Card,
      "deadband_compensation=0.65;pwm_en=0;enc0_velocity=3.0;enc1_velocity=3.0;min_diode_compensation=0.0;max_diode_compensation=0.0",
      126);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
...
RT_MODEL_q_qube2_bal_lqr_T *q_qube2_bal_lqr(void)
{
  ...
  /* External mode info */
  q_qube2_bal_lqr_M->Sizes.checksums[0] = (3914362177U);
  q_qube2_bal_lqr_M->Sizes.checksums[1] = (247418820U);
  q_qube2_bal_lqr_M->Sizes.checksums[2] = (3253316525U);
  q_qube2_bal_lqr_M->Sizes.checksums[3] = (3894744439U);
...

  {
    ...
    q_qube2_bal_lqr_B.SignalGenerator1 = 0.0;
  ...
  q_qube2_bal_lqr_M->Sizes.numBlockIO = (21);/* Number of block outputs */
  q_qube2_bal_lqr_M->Sizes.numBlockPrms = (112);/* Sum of parameter "widths" */
