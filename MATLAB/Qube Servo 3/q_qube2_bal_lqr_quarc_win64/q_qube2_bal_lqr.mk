###########################################################################
## Makefile generated for component 'q_qube2_bal_lqr'. 
## 
## Makefile     : q_qube2_bal_lqr.mk
## Generated on : Mon Jul 29 15:20:05 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_bal_lqr.rt-win64
...
PRODUCT_NAME              = q_qube2_bal_lqr
MAKEFILE                  = q_qube2_bal_lqr.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\pea4\DOWNLO~1\lab\COURSE~1\FUNDAM~1\Pendulum\LQR_CO~1\Software
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = q_qube2_bal_lqr_comp.rsp
CMD_FILE                  = q_qube2_bal_lqr.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_bal_lqr.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_qube2_bal_lqr -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr.c $(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_data.c $(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_main.c $(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_bal_lqr_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_bal_lqr.obj q_qube2_bal_lqr_data.obj q_qube2_bal_lqr_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_bal_lqr_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_bal_lqr_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_bal_lqr.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr.c"


q_qube2_bal_lqr_data.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_data.c"


q_qube2_bal_lqr_main.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\q_qube2_bal_lqr_main.c"


rtGetInf.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_bal_lqr_quarc_win64\rt_nonfinite.c"
