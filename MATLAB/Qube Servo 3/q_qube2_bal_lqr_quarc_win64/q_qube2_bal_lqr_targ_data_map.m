    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% q_qube2_bal_lqr_P.HILInitialize_POFinal
                    ...
                    ;% q_qube2_bal_lqr_P.HILInitialize_POFrequency
                    section.data(15).logicalSrcIdx = 17;
                    section.data(15).dtTransOffset = 19;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POLeading
                    section.data(16).logicalSrcIdx = 18;
                    section.data(16).dtTransOffset = 20;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POTrailing
                    section.data(17).logicalSrcIdx = 19;
                    section.data(17).dtTransOffset = 21;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POInitial
                    ...
                    ;% q_qube2_bal_lqr_P.SignalGenerator1_Frequency
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% q_qube2_bal_lqr_P.HILInitialize_POModes
                    section.data(4).logicalSrcIdx = 45;
                    section.data(4).dtTransOffset = 3;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POConfiguration
                    section.data(5).logicalSrcIdx = 46;
                    section.data(5).dtTransOffset = 4;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POAlignment
                    section.data(6).logicalSrcIdx = 47;
                    section.data(6).dtTransOffset = 5;

                    ;% q_qube2_bal_lqr_P.HILInitialize_POPolarity
    ...
    targMap.checksum0 = 3914362177;
    targMap.checksum1 = 247418820;
    targMap.checksum2 = 3253316525;
    targMap.checksum3 = 3894744439;
