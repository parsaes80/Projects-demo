...
#ifndef RTW_HEADER_q_qube2_bal_lqr_h_
#define RTW_HEADER_q_qube2_bal_lqr_h_
#ifndef q_qube2_bal_lqr_COMMON_INCLUDES_
#define q_qube2_bal_lqr_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_qube2_bal_lqr_COMMON_INCLUDES_ */

#include "q_qube2_bal_lqr_types.h"
#include "rtGetNaN.h"
...
#define q_qube2_bal_lqr_rtModel        RT_MODEL_q_qube2_bal_lqr_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadEncoderTimebase_o1;    /* '<S5>/HIL Read Encoder Timebase' */
  real_T HILReadEncoderTimebase_o2;    /* '<S5>/HIL Read Encoder Timebase' */
  real_T Pendulumcountstorad;          /* '<S6>/Pendulum:  counts to rad' */
  ...
  real_T Armcountstorad;               /* '<S6>/Arm: counts to rad' */
  real_T Gain_b[2];                    /* '<S4>/Gain' */
...
#define rtB                            q_qube2_bal_lqr_B
#define BlockIO                        B_q_qube2_bal_lqr_T
#define rtX                            q_qube2_bal_lqr_X
#define ContinuousStates               X_q_qube2_bal_lqr_T
#define rtXdot                         q_qube2_bal_lqr_XDot
#define StateDerivatives               XDot_q_qube2_bal_lqr_T
#define tXdis                          q_qube2_bal_lqr_XDis
#define StateDisabled                  XDis_q_qube2_bal_lqr_T
#define rtP                            q_qube2_bal_lqr_P
#define Parameters                     P_q_qube2_bal_lqr_T
#define rtDWork                        q_qube2_bal_lqr_DW
#define D_Work                         DW_q_qube2_bal_lqr_T

/* Parameters (default storage) */
struct P_q_qube2_bal_lqr_T_ {
  ...
  real_T Gain_Gain_a;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T SignalGenerator1_Amplitude;   /* Expression: 3
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  real_T SignalGenerator1_Frequency;   /* Expression: 5/3
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
...
struct tag_RTM_q_qube2_bal_lqr_T {
  const char_T *path;
...
extern P_q_qube2_bal_lqr_T q_qube2_bal_lqr_P;

/* Block signals (default storage) */
extern B_q_qube2_bal_lqr_T q_qube2_bal_lqr_B;

/* Continuous states (default storage) */
extern X_q_qube2_bal_lqr_T q_qube2_bal_lqr_X;

/* Block states (default storage) */
extern DW_q_qube2_bal_lqr_T q_qube2_bal_lqr_DW;

/* Model entry point functions */
extern void q_qube2_bal_lqr_initialize(void);
extern void q_qube2_bal_lqr_output(void);
extern void q_qube2_bal_lqr_update(void);
extern void q_qube2_bal_lqr_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_qube2_bal_lqr_rtModel *q_qube2_bal_lqr(void);
...
extern RT_MODEL_q_qube2_bal_lqr_T *const q_qube2_bal_lqr_M;

/*-
 * These blocks were eliminated from the model due to optimizations:
 *
 * Block '<Root>/u = 0V' : Unused code path elimination
 */
 ...
 *
 * '<Root>' : 'q_qube2_bal_lqr'
 * '<S1>'   : 'q_qube2_bal_lqr/Degrees to Radians'
 * '<S2>'   : 'q_qube2_bal_lqr/Enable Balance Control'
 * '<S3>'   : 'q_qube2_bal_lqr/Radians to Degrees'
 * '<S4>'   : 'q_qube2_bal_lqr/Radians to Degrees1'
 * '<S5>'   : 'q_qube2_bal_lqr/Rotary Pendulum Interface'
 * '<S6>'   : 'q_qube2_bal_lqr/Rotary Pendulum Interface/Counts to Angles'
 * '<S7>'   : 'q_qube2_bal_lqr/Rotary Pendulum Interface/State X'
 */
#endif                                 /* RTW_HEADER_q_qube2_bal_lqr_h_ */
